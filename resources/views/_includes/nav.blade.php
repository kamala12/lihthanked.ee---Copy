    ...
    <div class="container">
        <div class="navbar-brand">
            <a class="navbar-item is-paddingless brand-item" href="{{route('home')}}">
                <img src="{{asset('images/lihthanked-logo.png')}}" alt="Lihthanke logo">
            </a>
        ...
        <div class="navbar-menu">
            <div class="navbar-start">
                ...
                <a href="posts/create" class="navbar-item is-tab">Create</a>
            ...
            <div class="navbar-end nav-menu" style="overflow: visible">
                @guest
                    ...
                    <a href="{{route('register')}}" class="navbar-item is-tab is-active">Register</a>
                @else
